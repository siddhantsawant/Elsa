...
class Info:        
    ...
    async def invite(self):
        ...
        embed = discord.Embed(title="Elsa's Invite Link ", description="You can invite me to your server" ,color = 0x00ffff)
        ...
        embed.set_thumbnail(url = " https://cdn.discordapp.com/avatars/396540743877001216/4985aba7a92f9c5ac06c24fa54ea1fbf.webp?size=1024 ")
    ...
    async def info(self ,ctx, user: discord.Member = None):
        ...
        try:
            embed = discord.Embed(title="{}'s info".format(user.name), description="Here's what I could find in my bag...", color=0x00ffff)
...
#            embed.add_field(name="Roles" , value =str( user.roles) , inline =True)
    ...
    async def serverinfo(self , ctx):
        ...
        embed = discord.Embed(title="{}'s info".format(ctx.message.server.name), description="Here's what I could find in my bag...", color=0x00ffff)    
